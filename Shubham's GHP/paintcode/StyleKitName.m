...
//  ProjectName
//
//  Created by AuthorName on 2/7/15.
...
+ (void)drawCanvas1
{
    ...
    //// interests Drawing
    CGRect interestsRect = CGRectMake(33.5, 300, 249, 36);
    ...
    //// Musica Drawing
    CGRect musicaRect = CGRectMake(32.5, 350, 249, 36);
    ...
    //// a&h Drawing
    CGRect ahRect = CGRectMake(32.5, 400, 249, 36);
    ...
    CGRect inspirationsRect = CGRectMake(32.5, 450, 249, 36);
    ...
    //// soure Code Drawing
    CGRect soureCodeRect = CGRectMake(33.5, 500, 249, 36);
...
+ (void)drawMusic
{
    ...
    //// My music: Drawing
    CGRect myMusicRect = CGRectMake(106, 38, 108, 21);
    {
        NSString* textContent = @"My music:";
        CGContextSaveGState(context);
        CGContextSetShadowWithColor(context, shadowOffset, shadowBlurRadius, [shadow CGColor]);
        NSMutableParagraphStyle* myMusicStyle = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        myMusicStyle.alignment = NSTextAlignmentCenter;

        NSDictionary* myMusicFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.labelFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: myMusicStyle};

        CGFloat myMusicTextHeight = [textContent boundingRectWithSize: CGSizeMake(myMusicRect.size.width, INFINITY)  options: NSStringDrawingUsesLineFragmentOrigin attributes: myMusicFontAttributes context: nil].size.height;
        CGContextSaveGState(context);
        CGContextClipToRect(context, myMusicRect);
        [textContent drawInRect: CGRectMake(CGRectGetMinX(myMusicRect), CGRectGetMinY(myMusicRect) + (CGRectGetHeight(myMusicRect) - myMusicTextHeight) / 2, CGRectGetWidth(myMusicRect), myMusicTextHeight) withAttributes: myMusicFontAttributes];
        CGContextRestoreGState(context);
        CGContextRestoreGState(context);
    ...
    //// Rectangle 2 Drawing
    CGRect rectangle2Rect = CGRectMake(42, 120, 235.5, 67);
    ...
    [rectangle2Path stroke];
    {
        ...
        NSDictionary* rectangle2FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.labelFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: rectangle2Style};
    ...
    //// Rectangle 3 Drawing
    CGRect rectangle3Rect = CGRectMake(42, 360, 235.5, 67);
    ...
    {
        NSString* textContent = @"Study Music";
        ...
        NSDictionary* rectangle3FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.labelFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: rectangle3Style};
    ...
    //// Rectangle 4 Drawing
    CGRect rectangle4Rect = CGRectMake(42, 240, 235.5, 67);
    ...
    {
        NSString* textContent = @"The Good Ones";
        ...
        NSDictionary* rectangle4FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.labelFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: rectangle4Style};
    ...
    //// Info 2 Drawing
    CGRect info2Rect = CGRectMake(42, 72, 236, 31);
    {
        NSString* textContent = @"- What I like to listen to\n";
        NSMutableParagraphStyle* info2Style = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        info2Style.alignment = NSTextAlignmentCenter;
...
+ (void)drawHonors
{
    ...
    //// Rectangle Drawing
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRect: CGRectMake(1, 0, 320, 568)];
    [color8 setFill];
    [rectanglePath fill];


    //// Rectangle 2 Drawing
    CGRect rectangle2Rect = CGRectMake(54.5, 481.5, 212, 70);
    UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRoundedRect: rectangle2Rect cornerRadius: 10];
    [color5 setFill];
    [rectangle2Path fill];
    [color2 setStroke];
    ...
    [rectangle2Path stroke];
    {
        NSString* textContent = @"Check out my Varsity Letter! ";
        NSMutableParagraphStyle* rectangle2Style = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        rectangle2Style.alignment = NSTextAlignmentCenter;
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(16, 39, 290, 22);
    {
        NSString* textContent = @"Some of my Honors over the years: ";
        CGContextSaveGState(context);
        CGContextSetShadowWithColor(context, shadowOffset, shadowBlurRadius, [shadow CGColor]);
        NSMutableParagraphStyle* textStyle = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        textStyle.alignment = NSTextAlignmentLeft;
    ...
    //// Text 2 Drawing
    CGRect text2Rect = CGRectMake(16, 82, 290, 30);
    {
        NSString* textContent = @" - 43rd in Math Division at Vex World's in 2014 season.";
        ...
        NSDictionary* text2FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.systemFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: text2Style};
    ...
    //// Text 3 Drawing
    CGRect text3Rect = CGRectMake(16, 126, 290, 30);
    {
        NSString* textContent = @" - 13th in FTC robotics at state in 2013";
        ...
        NSDictionary* text3FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.systemFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: text3Style};
    ...
    //// Text 4 Drawing
    CGRect text4Rect = CGRectMake(16, 156, 290, 30);
    {
        NSString* textContent = @" - Varsity letter for Robotics in 2014";
        ...
        NSDictionary* text4FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.systemFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: text4Style};
    ...
    //// Text 5 Drawing
    CGRect text5Rect = CGRectMake(16, 186, 290, 37);
    {
        NSString* textContent = @" - Became GSMST TSA historian and On Demand Team Leader in 2014";
        ...
        NSDictionary* text5FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.systemFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: text5Style};
    ...
    //// Text 6 Drawing
    CGRect text6Rect = CGRectMake(16, 281, 290, 47);
    {
        NSString* textContent = @" - 10th place for Digital Video Production at TSA State Leadership Conference last year";
        ...
        NSDictionary* text6FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.systemFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: text6Style};
    ...
    //// Text 7 Drawing
    CGRect text7Rect = CGRectMake(16, 234, 290, 37);
    {
        NSString* textContent = @" - 9th place for On Demand Video at TSA State Leadership Conference last year";
        ...
        NSDictionary* text7FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.systemFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: text7Style};
    ...
    //// Text 8 Drawing
    CGRect text8Rect = CGRectMake(16, 349, 290, 47);
    {
        NSString* textContent = @" - Finished as a Semifinalist for Animatronics at TSA State Leadership Conference last year";
        ...
        NSDictionary* text8FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.systemFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: text8Style};
    ...
    //// Text 9 Drawing
    CGRect text9Rect = CGRectMake(16, 416, 290, 47);
    {
        NSString* textContent = @" - Interned at NCR over the last summer as a web developer, helped with the Madcap division";
        ...
        NSDictionary* text9FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: UIFont.systemFontSize], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: text9Style};
...
+ (void)drawVletter
{
    ...
    //// Image Declarations
    UIImage* image14 = [UIImage imageNamed: @"image14.jpg"];
    ...
    //// Rectangle 2 Drawing
    UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRect: CGRectMake(0, 75, 320, 432)];
    CGContextSaveGState(context);
    CGContextSetShadowWithColor(context, shadowOffset, shadowBlurRadius, [shadow CGColor]);
    CGContextBeginTransparencyLayer(context, NULL);
    CGContextSaveGState(context);
    [rectangle2Path addClip];
    CGContextScaleCTM(context, 1.0, -1.0);
    CGContextDrawTiledImage(context, CGRectMake(0, -75, image14.size.width, image14.size.height), image14.CGImage);
    CGContextRestoreGState(context);
    CGContextEndTransparencyLayer(context);
    CGContextRestoreGState(context);
}
...
+ (void)drawAllInterests
{
    ...
    //// Image Declarations
    UIImage* image10 = [UIImage imageNamed: @"image10.jpg"];
    UIImage* image11 = [UIImage imageNamed: @"image11.jpg"];
    UIImage* image12 = [UIImage imageNamed: @"image12.jpg"];
    UIImage* image13 = [UIImage imageNamed: @"image13.jpg"];
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(92, 37, 136, 33);
    {
        NSString* textContent = @"My interests ";
        CGContextSaveGState(context);
        CGContextSetShadowWithColor(context, shadowOffset, shadowBlurRadius, [shadow CGColor]);
        NSMutableParagraphStyle* textStyle = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        textStyle.alignment = NSTextAlignmentCenter;
    ...
    //// Text 2 Drawing
    CGRect text2Rect = CGRectMake(92, 67, 136, 33);
    {
        NSString* textContent = @"Click for more info";
        NSMutableParagraphStyle* text2Style = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        text2Style.alignment = NSTextAlignmentCenter;
...
+ (void)drawThreedmodeling
{
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(28, 187, 265, 104);
    {
        NSString* textContent = @"This year I took class 3d modeling, I took the class to further my relativily OK 3d skills and make it an addition to my video development aresenal. Eventually it well me with iOS development as well.";
        CGRect textInset = CGRectInset(textRect, 4, 0);
        NSMutableParagraphStyle* textStyle = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        textStyle.alignment = NSTextAlignmentCenter;

        NSDictionary* textFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"STHeitiTC-Medium" size: 15], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: textStyle};
    ...
    //// Text 2 Drawing
    CGRect text2Rect = CGRectMake(92, 81, 136, 33);
    {
    ...
    //// Rectangle 4 Drawing
    CGRect rectangle4Rect = CGRectMake(51.5, 413.5, 218, 106);
    UIBezierPath* rectangle4Path = [UIBezierPath bezierPathWithRoundedRect: rectangle4Rect cornerRadius: 5];
    [color5 setFill];
    [rectangle4Path fill];
    [color setStroke];
    ...
    [rectangle4Path stroke];
    {
        NSString* textContent = @"View some of my latest 3d creations";
        NSMutableParagraphStyle* rectangle4Style = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        rectangle4Style.alignment = NSTextAlignmentCenter;
...
+ (void)drawTSA
{
    ...
    //// Image Declarations
    UIImage* image19 = [UIImage imageNamed: @"image19.jpg"];
    ...
    //// Text 2 Drawing
    CGRect text2Rect = CGRectMake(58, 60, 204, 52);
    {
        NSString* textContent = @"Technology Student Association (TSA)";
        CGContextSaveGState(context);
        CGContextSetShadowWithColor(context, shadowOffset, shadowBlurRadius, [shadow CGColor]);
        NSMutableParagraphStyle* text2Style = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        text2Style.alignment = NSTextAlignmentCenter;
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(58, 133, 217, 112);
    {
        NSString* textContent = @"Last year as a general memeber I was in:\n- On Demand Video\n- Digital Video Production\n- Animatronics\n";
        NSMutableParagraphStyle* textStyle = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        textStyle.alignment = NSTextAlignmentLeft;
    ...
    //// Text 3 Drawing
    CGRect text3Rect = CGRectMake(58, 264, 217, 124);
    {
        NSString* textContent = @"Now as an officer (Historian), I’m responsible for all the media in the club, and I’m the leader for On demand";
        NSMutableParagraphStyle* text3Style = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
        text3Style.alignment = NSTextAlignmentCenter;
    ...
    //// Bezier Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, 0, 244);
    CGContextScaleCTM(context, 10, 1);

    UIBezierPath* bezierPath = UIBezierPath.bezierPath;
    [bezierPath moveToPoint: CGPointMake(0, 1)];
    [bezierPath addLineToPoint: CGPointMake(318, 1)];
    [color5 setFill];
    [bezierPath fill];
    [color5 setStroke];
    ...
    //// Rectangle 2 Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, 0, 388);

    UIBezierPath* rectangle2Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(0, -5, 320, 179) cornerRadius: 5];
    CGContextSaveGState(context);
    [rectangle2Path addClip];
    CGContextScaleCTM(context, 1.0, -1.0);
    CGContextDrawTiledImage(context, CGRectMake(0, 5, image19.size.width, image19.size.height), image19.CGImage);
    CGContextRestoreGState(context);
